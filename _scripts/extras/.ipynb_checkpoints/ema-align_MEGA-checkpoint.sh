...
# fastq directory
if [ $coverage = "2x" ];
then fastq_dir=${WORKDIR}/fastq/haplotag_MEGA_n960_2022/${coverage}Coverage/$plate; #2x;
else fastq_dir=${WORKDIR}/fastq/haplotag_MEGA_n960_2022/${coverage}Coverage; #10x/60x;
fi
# EMA-mapped reads directory
ema_dir=${WORKDIR}/bams/bams_MEGA/ema_dir/${coverage}Coverage/$plate #2x/10x/60x
ema_align=${WORKDIR}/bams/bams_MEGA/ema_align/${coverage}Coverage/
...
## Set sequence info
library='Snapdragon-Haplo-n960-2022'
...
## Reading inputs
echo Reading inputs
samp_info=$fastq_dir/samples_${coverage}_${plate}.txt #file: sample ID
echo $samp_info
...
read2=${read1/_R1/_R2}
samp=${prefix}_${coverage}_${plate} #eg, pb0112_2x_N701 
fbname=${samp}_${ref_gen_ver}.sorted #eg, pb0112_2x_N701_v3.sorted
