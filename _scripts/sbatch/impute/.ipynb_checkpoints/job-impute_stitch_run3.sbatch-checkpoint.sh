...
##### SLURM script to run STITCH imputation (Run 3)
##### author: Arka Pal
##### written: 20.03.2024
##### update: 20.03.2024
...
outputDIR=~/snap_hap/variants/stitch_run3/$chrom/stitch_chromSegments/$(basename ${posfile/.pos})_K${K}_cov${downsampleToCov}_bxTRUE_niter${niter}_ngen${ngen}_r${expRate}_plotFALSE
if [ ! -d  ~/snap_hap/variants/stitch_run3/$chrom/stitch_chromSegments ]; then mkdir -p ~/snap_hap/variants/stitch_run3/$chrom/stitch_chromSegments; fi
