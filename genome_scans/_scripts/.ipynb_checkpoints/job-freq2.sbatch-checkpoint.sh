...
##### SLURM script to calculate allele frequencies
##### author: Arka Pal
##### written: 03.04.3034
##### update: 03.04.3034

##### USAGE: sbatch -J <jobname> job-freq2.sbatch.sh <options>
##### $1 - vcf
...
## Run commands -----
srun vcftools --gzvcf $inVCF --keep $sampleFile --freq2 --out $output