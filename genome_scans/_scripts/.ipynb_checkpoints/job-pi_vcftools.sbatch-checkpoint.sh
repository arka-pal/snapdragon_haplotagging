...
##### SLURM script to calculate pi with VCFtools
##### author: Arka Pal
##### written: 03.04.3034
##### update: 03.04.3034

##### USAGE: sbatch -J <jobname> job-pi_vcftools.sbatch.sh <options>
##### $1 - vcf
...
## Run commands -----
srun vcftools --gzvcf $inVCF --keep $pop --site-pi --out $output